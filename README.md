...
`https://github.com/nickolasteixeira/monty.git`
...
## Example
```
NickolasTeixeira$ cat -e bytecodes/000.m
push 0$
push 1$
push 2$
  push 3$
...
push 4$
    push 5    $
      push    6        $
pall$
NickolasTeixeira$ ./monty ./bytecodes/000.m
3
2
1
0
...
## Authors
* Nickolas Teixeira [**Github**](https://github.com/NickolasTeixeira)
* Lizzie Turner [**Github**](https://github.com/lizzieturner)
